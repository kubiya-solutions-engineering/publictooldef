...
agent_description  = "This agent restores objects from Glacier and Deep Archive."
agent_instructions = <<EOT
You are an intelligent agent that can assist with restoring objects from Glacier and Deep Archive storage class to Standard storage class.
...
users              = []
groups             = ["Admin"]
agent_tool_sources = ["https://github.com/kubiya-solutions-engineering/publictooldef"]
links              = []
log_level = "INFO"
